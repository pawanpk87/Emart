...
public class UpdateEmployeeFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Update employees Panel", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 24), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            e.setEmpID(jcomboEmpId.getSelectedItem().toString());
            e.setEmpName(txtEmpName.getText());
            e.setSal(Double.parseDouble(txtEmpSal.getText()));
            e.setJob(jcomboJob.getSelectedItem().toString());
            boolean result=EmployeeDao.updateEmployee(e);
            
            if(!result)
            {
               JOptionPane.showMessageDialog(null,"Record could not Update !","Error!",JOptionPane.ERROR_MESSAGE);               
               return;
            }
            else
            {
